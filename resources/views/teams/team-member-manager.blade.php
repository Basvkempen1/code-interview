                                    ...
                                    <button type="button"
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center">
                                                <div
                                                    class="text-sm text-gray-600 dark:text-gray-100 {{ $addTeamMemberForm['role'] == $role->key ? 'font-semibold' : '' }}">
                                                    {{ $role->name }}
                                                </div>
                            ...
                            <div class="flex items-center justify-between border-b pb-3">
                                ...
                                <div class="flex items-center">
                                    @if (Gate::check('removeTeamMember', $team))
                                        ...
                                        <button
                                            class="cursor-pointer ml-6 px-4 py-2 text-sm rounded-md text-red-500 border border-red-500 focus:outline-none"
